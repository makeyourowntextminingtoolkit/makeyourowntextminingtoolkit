...
def delete_indices(content_directory):
    cooccurance_index_file = content_directory + "index.cooccurance"
    if os.path.isfile(cooccurance_index_file):
        os.remove(cooccurance_index_file)
        print("removed co-occurance index file: ", cooccurance_index_file)
        pass
    pass
...
def print_index(content_directory):
    cooccurance_index_file = content_directory + "index.coocurrance"
    hd5_store1 = pandas.HDFStore(cooccurance_index_file, mode='r')
    cooccurance_index = hd5_store1['corpus_index']
    hd5_store1.close()
    print("cooccurance_index_file ", cooccurance_index_file)
    print(cooccurance_index.head(10))
    pass
